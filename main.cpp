...
glm::vec3 lightPos = glm::vec3(0.0f, 6.0f, 9.0f);
...
{
    Mesh *obj1 = new Mesh();
    bool loaded = obj1->CreateMeshFromOBJ("Models/cactus.obj");
    if (loaded)
    {
        meshList.push_back(obj1);
    }
    ...
    Mesh *obj2 = new Mesh();
    loaded = obj2->CreateMeshFromOBJ("Models/table.obj");
    if (loaded)
    {
    ...
    Mesh *obj3 = new Mesh();
    loaded = obj3->CreateMeshFromOBJ("Models/youtube.obj");
    if (loaded)
    {
    ...
    Mesh *obj4 = new Mesh();
    loaded = obj4->CreateMeshFromOBJ("Models/cube.obj");
    if (loaded)
    {
...
int main()
{
    ...
    char *texPath[] =
        {
            "Textures/cactus.png",
            "Textures/table_col.png",
            "Textures/youtube.png"};

    // texture
    int n_texture = sizeof(texPath) / sizeof(texPath[0]);
    unsigned int textures[n_texture];
    ...
    while (!mainWindow.getShouldClose())
    {
        ...
        meshList[meshList.size() - 1]->RenderMesh();
